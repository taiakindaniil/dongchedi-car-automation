...
from avto_bot.url_builder import build_url, iter_urls
...
def test_brand_only_matches_audi_link() -> None:
    ...
    assert build_url(f) == BASE + "x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-2-x-110000-1-x-x-x-x-x"


def test_sedan_family() -> None:
    f = FiltersConfig(city=110000, body_family=[BodyFamily.sedan])
    assert build_url(f) == BASE + "x-0-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-110000-1-x-x-x-x-x"


def test_suv_family() -> None:
    f = FiltersConfig(city=110000, body_family=[BodyFamily.suv])
    assert build_url(f) == BASE + "x-1-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-110000-1-x-x-x-x-x"


def test_compact_suv_class() -> None:
    f = FiltersConfig(city=110000, body_class=[BodyClass.compact_suv])
    assert build_url(f) == BASE + "x-x-x-x-x-x-x-x-x-x-x-x-11-x-x-x-x-x-x-x-x-110000-1-x-x-x-x-x"


def test_price_under_3wan() -> None:
    f = FiltersConfig(city=110000, price_wan=(None, 3))
    assert build_url(f) == BASE + "0,3-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-110000-1-x-x-x-x-x"


def test_price_over_20wan() -> None:
    f = FiltersConfig(city=110000, price_wan=(20, None))
    assert build_url(f) == BASE + "20,!1-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-110000-1-x-x-x-x-x"


def test_price_range_15_20wan() -> None:
    f = FiltersConfig(city=110000, price_wan=(15, 20))
    assert build_url(f) == BASE + "15,20-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-110000-1-x-x-x-x-x"


def test_mileage_under_5wan() -> None:
    f = FiltersConfig(city=110000, km_max_wan=5)
    assert build_url(f) == BASE + "x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-0,5-x-x-x-x-x-110000-1-x-x-x-x-x"


def test_fuel_bev() -> None:
    f = FiltersConfig(city=110000, fuel=[Fuel.bev])
    assert build_url(f) == BASE + "x-x-x-x-x-x-4-x-x-x-x-x-x-x-x-x-x-x-x-x-x-110000-1-x-x-x-x-x"
...
def test_fuel_new_energy_combo() -> None:
    ...
    assert build_url(f) == BASE + "x-x-x-x-x-x-4,5,6-x-x-x-x-x-x-x-x-x-x-x-x-x-x-110000-1-x-x-x-x-x"


def test_manual_transmission() -> None:
    f = FiltersConfig(city=110000, transmission=Transmission.manual)
    assert build_url(f) == BASE + "x-x-x-1-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-110000-1-x-x-x-x-x"


def test_awd_drive() -> None:
    f = FiltersConfig(city=110000, drive=Drive.awd)
    assert build_url(f) == BASE + "x-x-x-x-x-x-x-x-3-x-x-x-x-x-x-x-x-x-x-x-x-110000-1-x-x-x-x-x"


def test_emission_guo6() -> None:
    f = FiltersConfig(city=110000, emission=Emission.guo6)
    assert build_url(f) == BASE + "x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-7-x-x-x-110000-1-x-x-x-x-x"


def test_origin_import() -> None:
    f = FiltersConfig(city=110000, origin=Origin.import_)
    assert build_url(f) == BASE + "x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-4-x-x-110000-1-x-x-x-x-x"
...
def test_pagination_increments_position_23() -> None:
    f = FiltersConfig(city=110000)
    p2 = build_url(f, page=2)
    assert p2 == BASE + "x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-110000-2-x-x-x-x-x"
...
def test_iter_urls_fanout_per_brand() -> None:
    ...
    assert "-3-x-110000-1-" in urls[0][1]
    assert "-3-x-110000-2-" in urls[1][1]
    assert "-4-x-110000-1-" in urls[2][1]
